...
module.exports = {
  ...
  aliases: ['ti'],
  help: {
    purpose: 'Devuelve el tier/dificultad de un nivel usando la API de AREDL.',
    category: '🎮 Diversión',
  },
  async execute(message, args) {
    ...
    if (!query) {
      return message.reply(makeV2Card({
        title: '❌ Uso inválido',
        subtitle: 'Uso: `-tier <nombre del nivel>`',
    ...
    try {
      ...
      return message.reply('❌ Error al consultar la API de AREDL. Intenta de nuevo más tarde.');
    }
